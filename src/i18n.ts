...
export const translations = {
  ...
  cs: {
    ...
    show: "Zobrazit",
    hide: "Skrýt",
    formulaDescription: "Lineární kongruentní generátory generují pseudonáhodná čísla iterací této modulární rovnice. Nevhodná volba parametrů a a m vede k tomu, že body v 3D prostoru leží v nadrovinách.",
    ...
    shuffle: "Bays-Durhamovo míchání",
